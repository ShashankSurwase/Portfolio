...
const PROJECTS: Project[] = [
  ...
  { id: "energy_realtime_streaming_migration", title: "Real-Time Streaming Migration (Kinesis)", domain: "Energy", impact: "A streaming lane — producer → Kinesis → Redshift streaming materialized view — that cut plant-to-warehouse latency from minutes to seconds with exactly-once loads.", tags: ["Kinesis", "Redshift Streaming", "Exactly-Once"], repo: repoUrl("Energy", 10) },
